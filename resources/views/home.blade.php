            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="#!"> <img src="{{ asset('images/products/product-img-1.jpg') }}" alt="Grocery Ecommerce Template"
                  ...
                  <div class="card-product-action">
                    ...
                    <a href="#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" title="Lista de Favoritos"><i
            ...
            <div class="card card-product">
              <div class="card-body">
                ...
                <div class="text-center position-relative ">
                  ...
                  <a href="#!"> <img src="{{ asset('') }}images/products/product-img-6.jpg" alt="Grocery Ecommerce Template"
                      class="mb-3 img-fluid"></a>
                  <div class="card-product-action">
                    <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                        class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Olhada Rápida"></i></a>
                    <a href="../pages/shop-wishlist.html" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" title="Lista de Favoritos"><i
                        class="bi bi-heart"></i></a>
                    <a href="#!" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true" title="Comparar"><i
                        class="bi bi-arrow-left-right"></i></a>
                  </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3">
            <div class="mb-8 mb-xl-0">
              ...
              <p>Faça com que seu pedido seja entregue à sua porta o mais rápido possível nas lojas de coleta FreshCart perto de você.</p>
            </div>
          </div>
          <div class="col-md-6  col-lg-3">
            <div class="mb-8 mb-xl-0">
              ...
              <p>Preços mais baratos do que o supermercado local, ótimas ofertas de reembolso para completar. Obtenha os melhores preços e ofertas.
              </p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="mb-8 mb-xl-0">
              ...
              <p>Escolha entre mais de 5.000 produtos em alimentos, cuidados pessoais, casa, padaria, vegetais e não vegetais e outras categorias.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="mb-8 mb-xl-0">
              ...
              <p>Não está satisfeito com um produto? Devolva-o na porta e receba um reembolso em poucas horas. Sem perguntas sobre política.
                <a href="#!">política</a>.</p>
            </div>
          </div>
        </div>

                        ...
                        <div class="offcanvas-body ps-lg-2 pt-lg-0">
                                    ...
                                    <li class="nav-item border-bottom w-100">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <i class="feather-icon icon-chevron-right" data-bs-toggle="collapse"
                                                data-bs-target="#category{{ $nestedCategory->id }}"
                                                aria-expanded="false"
                                        ...
                                        @if ($nestedCategory->children)
                                        <!-- accordion collapse -->
                                        <div id="category{{ $nestedCategory->id }}"
                            ...
                            {{-- <div class="mb-8">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">Preço:</small> <span id="priceRange-value"
                                        class="small"></span>
                ...
                <section class="col-lg-9 col-md-12">
                    ...
                    <div class="d-lg-flex justify-content-between align-items-center">
                        <div class="mb-3 mb-lg-0">
                            <p class="mb-0"> <span class="text-dark">{{ !empty($products) ? $products->total() : 0}}
                                </span> Produtos
                                encontrados </p>
                        </div>
                                ...
                                <div class="d-flex mt-2 mt-lg-0">
                                    <div class="me-2 flex-grow-1">
                                        ...
                                        <select name="per_page" class="form-select" onchange="this.form.submit()">
                                            <option value="32" {{ Request::get('per_page')==32 ? 'selected' : '' }}>
                                                Exibir: 32</option>
                                            <option value="24" {{ Request::get('per_page')==24 ? 'selected' : '' }}>
                                                Exibir: 24</option>
                                            <option value="16" {{ Request::get('per_page')==16 ? 'selected' : '' }}>
                                                Exibir: 16</option>
                                        </select>
                                    </div>
                                    <div>
                                        ...
                                        <select name="order_by" class="form-select" onchange="this.form.submit()">
                                            <option value="highlighted" {{ Request::get('order_by')=='featured'
                                                ? 'selected' : '' }}>Em
                                                destaque
                                            </option>
                                            <option value="low_to_high" {{ Request::get('order_by')=='low_to_high'
                                                ? 'selected' : '' }}>Preço:
                                                menor para o maior</option>
                                            <option value="high_to_low" {{ Request::get('order_by')=='high_to_low'
                                                ? 'selected' : '' }}>Price:
                                                maior para o menor</option>
                                            <option value="release_date" {{ Request::get('order_by')=='release_date'
                                                ? 'selected' : '' }}>Data
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center position-relative ">
                                        <div class="position-absolute top-0 start-0">
                                            ...
                                            $discountPercentage = round(($regularPrice - $salePrice) / $regularPrice *
                                            100);
                                            @endphp
                                        ...
                                        <div class="card-product-action">
                                            <a href="#!" class="btn-action" data-bs-toggle="modal"
                                                ...
                                                onclick="showProductViewModal({{ $product }})"><i class="bi bi-eye"

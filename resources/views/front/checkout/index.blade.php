                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <div class="accordion-item py-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#" class="fs-5 text-inherit collapsed h4" data-bs-toggle="collapse"
                                        ...
                                        <i class="feather-icon icon-map-pin me-2 text-muted"></i>Adicionar endereço de
                                        entrega
                                    </a>
                                    <!-- btn -->
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse "
                                    ...
                                    <ul class="nav nav-pills nav-pills-light mb-3 nav-fill mt-5" id="pills-tab"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link active" id="pills-today-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-today" aria-selected="true">Hoje <br><small>3 de
                                                    outobro</small>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link" id="pills-monday-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-monday" aria-selected="false">seg <br><small>4 de
                                                    outubro</small>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link" id="pills-Tue-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-Tue" aria-selected="false">ter <br><small>5 de
                                                    outubro</small></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <!-- button -->
                                            <button class="nav-link" id="pills-Wed-tab" data-bs-toggle="pill"
                                                data-bs-target="#pills-Wed" type="button" role="tab"
                                                aria-controls="pills-Wed" aria-selected="false">qua <br><small>6 de
                                                    outubro</small></button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <!-- button -->
                                            <button class="nav-link" id="pills-Thu-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-Thu" aria-selected="false">qui <br> <small>O7 de
                                                    outubro</small> </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <!-- button -->
                                            <button class="nav-link" id="pills-Fri-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-Fri" aria-selected="false">sex <br> <small>8 de
                                                    outubro
                                                    8</small> </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            ...
                                            <button class="nav-link" id="pills-Sat-tab" data-bs-toggle="pill"
                                                ...
                                                aria-controls="pills-Sat" aria-selected="false">sab <br> <small>9 de
                                                    outubro</small>
                                            </button>
                                        </li>
                                    </ul>
                                            ...
                                            <ul class="list-group list-group-flush mt-4">
                                                ...
                                                <li
                                                    ...
                                                    <div class="col-3 text-center"> <span
                                                            class="badge bg-danger">Pago</span></div>
                                                    <!-- col -->
                                                    <div class="col-2 text-end"> <a href="#"
                                                            class="btn btn-outline-gray-400 btn-sm text-muted">Escolher</a>
                                                    </div>
                                                ...
                                                <li
                                                    ...
                                                    <div class="col-3 text-center"><span
                                                            class="badge bg-success">Livre</span></div>
                                                    <!-- col -->
                                                    <div class="col-2 text-end"> <a href="#"
                                                            class="btn btn-outline-gray-400 btn-sm text-muted">Escolher</a>
                                                    </div>
                                    ...
                                    <div class="mt-5 d-flex justify-content-end">
                                        <a href="#" class="btn btn-outline-gray-400 text-muted"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapseOne">Anterior</a>
                            ...
                            <div class="accordion-item py-4">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse "
                                    ...
                                    <div class="mt-5">
                                        <label for="DeliveryInstructions" class="form-label sr-only"> Instruções de
                                            entrega</label>
                                        <textarea class="form-control" id="DeliveryInstructions" rows="3"
                                            placeholder="Instruções de entrega "></textarea>
                                        <p class="form-text">Adicione instruções sobre como você deseja que seu pedido
                                            seja comprado e/ou entregue</p>
                                        <div class="mt-5 d-flex justify-content-end">
                                            <a href="#" class="btn btn-outline-gray-400 text-muted"
                                                data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo"
                                                aria-expanded="false" aria-controls="flush-collapseTwo">Anterior</a>
                                            <a href="#" class="btn btn-primary ms-2" data-bs-toggle="collapse"
                                                ...
                                                <div class="card-body p-6">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0 small">Você será redirecionado ao site do
                                                                PayPal para concluir sua compra com segurança.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="d-flex mb-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0 small">Transferência segura de dinheiro
                                                                usando sua conta bancária. Apoiamos Mastercard tercard,
                                                ...
                                                <div class="card-body p-6">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0 small">Você será redirecionado ao site da
                                                                Payoneer para concluir sua compra com segurança.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body p-6">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="mb-0 small">Pague em dinheiro quando seu pedido
                                                                for entregue.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item px-4 py-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-3 text-lg-end text-start text-md-end col-md-3">
                                                ...
                                                <div class="text-decoration-line-through text-muted small">R$26.00
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="list-group-item px-4 py-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-3 text-lg-end text-start text-md-end col-md-3">
                                                ...
                                                <div class="text-decoration-line-through text-muted small">R$20.00
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li class="list-group-item px-4 py-3">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between  ">
                                            <div>
                                                Taxa de Serviço <i class="feather-icon icon-info text-muted"

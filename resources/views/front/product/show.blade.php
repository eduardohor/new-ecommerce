        ...
        <div class="col-md-6">
          <div class="ps-lg-10 mt-6 mt-md-0">
            ...
            <div class="fs-4">
              ...
              <span class="{{ $product->sale_price > 0 ? 'text-decoration-line-through text-muted' : 'text-dark' }}">
                      ...
                      <div class="mb-5">
                        ...
                        <span>
                          <!-- rating --> <small class="text-warning"> <i class="bi bi-star-fill"></i>
                            ...
                            class="ms-3">11,130 avaliações globais</small>
                        </span>
                      </div>
                      <div class="mb-8">
                        <!-- progress -->
                      ...
                      <div class="d-flex border-bottom pb-6 mb-6">
                        ...
                        <div class="ms-5">
                          ...
                          <div class=" mb-2">
                            ...
                            <i class="bi bi-star-fill text-warning"></i>
                            <i class="bi bi-star-fill text-warning"></i>
                            <span class="ms-3 text-dark fw-bold">Precisa verificar novamente o peso no ponto de
                              entrega</span>
                          </div>
                          <!-- text-->
                          <p>A qualidade do produto é boa. Mas o peso parecia inferior a 1kg. Por ser enviado em pacote
                            aberto, existe a possibilidade de furto no meio. FreshCart envia os vegetais e frutas
                            através de tampas plásticas lacradas e código de barras no peso etc.</p>
                          <div>
                          ...
                          <div class="d-flex justify-content-end mt-4">
                            ...
                            <a href="#" class="text-muted ms-4"><i class="feather-icon icon-flag me-2"></i>Denunciar
                              Abuso</a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                        ...
                        <div class="ms-5">
                          ...
                          <p class="small"> <span class="text-muted">28 de Dezembro de 2022</span>
                            <span class="text-danger ms-3 fw-bold">Compra Não Verificada</span>
                          </p>
                          <!-- rating -->
                          <div class=" mb-2">
                            <i class="bi bi-star-fill text-warning"></i>
                          ...
                          <p>Sempre que peço bananas frescas, recebo bananas amarelo-esverdeadas exatamente como eu
                            queria, então vá em frente, é muito raro você superar as maduras.</p>
          ...
          <div class="card card-product">
            <div class="card-body">
              ...
              <div class="text-center position-relative ">
                ...
                <a href="{{ route('product.show', $relatedProduct->id) }}"> <img
                    src="{{ asset('storage/' . $imagesRelatedProduct->first()->image_path) }}"
                    alt="Image Produto {{ $relatedProduct->title }}" class="mb-4 mt-6 img-fluid"></a>

                <div class="card-product-action">
                  <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#productViewModal"
                    onclick="showProductViewModal({{ $relatedProduct }})"><i class="bi bi-eye" data-bs-toggle="tooltip"
              ...
              <div class="text-small mb-1"><a href="{{ route('category-products', $categoryRelatedProduct->slug) }}"
                  class="text-decoration-none text-muted"><small>{{
                    $categoryRelatedProduct->name }}</small></a></div>
              <h2 class="fs-6"><a href="{{ route('product.show', $relatedProduct->id) }}"
              ...
              <div class="d-flex justify-content-between align-items-center mt-3">
                <div>
                  @if($relatedProduct->sale_price > 0)
                  <span class="text-dark">{{ 'R$' . number_format($relatedProduct->sale_price, 2, ',', '.') }}</span>
                  @endif

        ...
        <section class="col-lg-9 col-md-12">
          ...
          <div class="d-lg-flex justify-content-between align-items-center">
            <div class="mb-3 mb-lg-0">
              <p class="mb-0"> <span class="text-dark">24 </span> Produtos encontrados </p>
            </div>
            ...
            <div class="d-md-flex justify-content-between align-items-center">
              ...
              <div class="d-flex mt-2 mt-lg-0">
                ...
                <div>
                  <!-- select option -->
                  <select class="form-select">
                    <option selected>Classificar por: Em destaque</option>
                    <option value="Low to High">Preço: menor para o maior</option>
                    <option value="High to Low"> Price: maior para o menor</option>
              ...
              >
                ...
                <div class="col-lg-4 col-md-5 col-6 d-grid">
                  ...
                  <button type="button" class="btn btn-primary">
                    <i class="feather-icon icon-shopping-bag me-2"></i>Adicionar ao Carrinho
                  </button>
                </div>

...
@section('title', 'Editar Página Institucional')
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xl-10 col-12 mb-5">
        <form action="{{ route('institutional-pages.update', $page) }}" method="post">
          @csrf
          @method('PUT')
          @include('admin.institutional_pages._form', ['submitLabel' => 'Atualizar Página'])
        </form>
      </div>
    </div>
  </div>

                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Nome da Categoria"
                                        @error('name') autofocus @enderror value="{{ old('name') }}" required>
                                    @error('name')
                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <input type="text" name="slug" class="form-control" placeholder="Slug"
                                        @error('slug') autofocus @enderror value="{{ old('slug') }}" required>
                                    @error('slug')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-lg-12 ">
                                    ...
                                    <input type="hidden" name="description" id="description" @error('description')
                                        autofocus @enderror>
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3 col-lg-12 ">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="inlineRadio1"
                                            value="Ativo" checked {{ old('status')=='Ativo' ? 'checked' : '' }}>
                                ...
                                <div class="mb-3 col-lg-12 mt-5 ">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="metatitle" class="form-control" placeholder="Título"
                                            @error('metatitle') autofocus @enderror value="{{ old('metatitle') }}">
                                        @error('metatitle')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>

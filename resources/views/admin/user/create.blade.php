                    ...
                    <div>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Adicinoar Novo Usuário</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- button -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Digite o nome"
                                        value="{{ old('name') }}" required autocomplete="name" @error('name') autofocus
                                        @enderror>
                                    @error('name')
                                ...
                                <div class="col-md-6 mb-5">
                                    ...
                                    <input type="password" name="password" class="form-control" placeholder="********"
                                        value="{{ old('password') }}" autocomplete="new_password" @error('password')
                                        autofocus @enderror>
                                    @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-5">
                                    ...
                                    <input type="password" name="password_confirmation" class="form-control"
                                        ...
                                        autocomplete="new_password" @error('password') autofocus @enderror>
                                    @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>

      ...
      <div class="col-lg-4 col-12 mb-6">
        ...
        <div class="card h-100 card-lg">
          ...
          <div class="card-body p-6">
            ...
            <!-- project number -->
            <div class="lh-1">
              <h1 class=" mb-2 fw-bold fs-2">R$93.438,78</h1>
        ...
        <div class="card h-100 card-lg">
          ...
          <div class="card-body p-6">
            ...
            <div class="lh-1">
              ...
              <span><span class="text-dark me-1">Mais de 35</span>Novas Vendas</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card h-100 card-lg">
          ...
          <div class="card-body p-6">
            ...
            <div class="lh-1">
              ...
              <span><span class="text-dark me-1">Mais de 30</span>Novos em 2 dias</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card h-100 card-lg">
          <div class="card-body p-6">
            ...
            <div class="d-flex justify-content-between">
              <div>
                <h3 class="mb-1 fs-5">Receita </h3>
                <small>(+63%) que no ano passado</small>
              </div>
              <div>
                <!-- select option -->
          ...
          <div class="card-body p-6">
            ...
            <div class="mt-4">
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="8" height="8" fill="currentColor"

                            ...
                            <form method="post" action="{{ route('profile.update.admin') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        ...
                                        required autocomplete="username" @error('email' ) autofocus @enderror>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <form method="post" action="{{ route('password.update') }}" class=" col row-cols-1 row-cols-lg-2">
                        ...
                        <div class="mb-3 col">
                            ...
                            <input type="password" class="form-control" placeholder="**********" name="current_password"
                                autocomplete="current-password" @error('current_password', 'updatePassword' ) autofocus
                                @enderror>
                        ...
                        <!-- button and success message -->
                        <div class="mb-3 d-flex align-items-center">
                            {{-- <p class="mb-4">Não consegue lembrar sua senha atual?<a
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="password" id="password" name="password" class="form-control"
                                placeholder="Digite sua senha" @error('password', 'userDeletion' ) autofocus
                                @enderror />

                        ...
                        <form method="POST" action="{{ route('coupons.update', $coupon) }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                                       value="{{ old('code', $coupon->code) }}" placeholder="EX: PROMO10" required>
                                @error('code')
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                        <option value="fixed" {{ old('type', $coupon->type) === 'fixed' ? 'selected' : '' }}>Valor</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" min="0" name="value"
                                           ...
                                           value="{{ old('value', $coupon->value) }}" placeholder="Ex: 10.00" required>
                                    @error('value')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row g-3 mt-1">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" min="1" name="max_uses"
                                           ...
                                           value="{{ old('max_uses', $coupon->max_uses) }}" placeholder="Deixe em branco para ilimitado">
                                    @error('max_uses')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" min="0" name="min_order_value"
                                           ...
                                           value="{{ old('min_order_value', $coupon->min_order_value) }}" placeholder="Opcional">

 ...
 <footer class="footer">
  <div class="container">
      ...
      <div class="col-12 col-md-12 col-lg-8">
        <div class="row g-4">
          <div class="col-6 col-sm-6 col-md-3">
            <h6 class="mb-4">Conheça-nos</h6>
              <!-- list -->
            <ul class="nav flex-column">
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Empresa</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Sobre</a></li>
              <li class="nav-item mb-2"><a href="#1" class="nav-link">Blog</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Central de Ajuda</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Nosso Valor</a></li>
            </ul>
          </div>
          <div class="col-6 col-sm-6 col-md-3">
            ...
            <ul class="nav flex-column">
                  <!-- list -->
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Pagamentos</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Envio</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Devoluções de Produtos</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Perguntas Frequentes</a></li>
            </ul>
          </div>
          <div class="col-6 col-sm-6 col-md-3">
            <h6 class="mb-4">Torne-se um comprador</h6>
            <ul class="nav flex-column">
                <!-- list -->
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Oportunidades para compradores</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Torne-se um comprador</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Ganhos</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Ganhos</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Novos varejistas</a></li>
            </ul>
          </div>
          <div class="col-6 col-sm-6 col-md-3">
            <h6 class="mb-4">Programas Freshcart</h6>
            <ul class="nav flex-column">
                <!-- list -->
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Programas Freshcart</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Cartões de presente</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Promoções e cupons</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Anúncios Freshcart</a></li>
              <li class="nav-item mb-2"><a href="#!" class="nav-link">Carreiras</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 mt-4 mt-md-0">
          <ul class="list-inline mb-0 text-lg-end text-center">
            <li class="list-inline-item mb-2 mb-md-0 text-dark">Obtenha entregas</li>
    ...
    <div class="border-top py-4">
      ...
      </span> Todos os direitos reservados. Desenvolvido por  <a href="#">MRP Solution</a>.</span></div>
        <div class="col-md-6">
